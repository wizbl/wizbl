...
{
    BOOST_CHECK(TestSplitHost("www." TEXT_wizbl "coin.org", "www." TEXT_wizbl "coin.org", -1));
    BOOST_CHECK(TestSplitHost("[www." TEXT_wizbl "coin.org]", "www." TEXT_wizbl "coin.org", -1));
    BOOST_CHECK(TestSplitHost("www." TEXT_wizbl "coin.org:80", "www." TEXT_wizbl "coin.org", 80));
    BOOST_CHECK(TestSplitHost("[www." TEXT_wizbl "coin.org]:80", "www." TEXT_wizbl "coin.org", 80));
