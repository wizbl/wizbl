...
#ifndef WIZBLCOIN_TEST_SCRIPTNUM10_H
#define WIZBLCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Wizblcoin Core 0.10.0, for cross-comparison.
 */
public:
