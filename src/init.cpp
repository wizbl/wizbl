 ...
 * between wizblcoind, and wizblcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread(TEXT_wizbl "coin-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), WIZBLCOIN_CONF_FILENAME));
    if (mode == HMM_WIZBLCOIND)
    {
#if HAVE_DECL_DAEMON
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), WIZBLCOIN_PID_FILENAME));
#endif
...
{
    //const std::string URL_SOURCE_CODE = "<https://github.com/" TEXT_wizbl "coin/" TEXT_wizbl "coin>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread(TEXT_wizbl "coin-loadblk");
...
/** Sanity checks
 *  Ensure that Wizblcoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf(TEXT_Wizbl "coin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Wizblcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", WIZBLCOIN_CONF_FILENAME)).string());
