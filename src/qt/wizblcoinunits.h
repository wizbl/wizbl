...
#ifndef WIZBLCOIN_QT_WIZBLCOINUNITS_H
#define WIZBLCOIN_QT_WIZBLCOINUNITS_H
...
/** Wizblcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WizblcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WizblcoinUnits(QObject *parent);

    /** Wizblcoin units.
     *  Wizblcoin units (Wizblcoin Core unit work the same as Bitoin).
     *  @note Source: https://en.wizblcoin.it/wiki/Units . 
    ...
    static int decimalsLength(int unit);
    //! Format as string
    static QString format(int unit, const CAmount& amount, bool plussign=false, SeparatorStyle separators=separatorStandard, bool decimalDisplayDecrease = false);
...
typedef WizblcoinUnits::Unit WizblcoinUnit;

#endif // WIZBLCOIN_QT_WIZBLCOINUNITS_H
