    ...
    transactionView(0), /*abandonAction(0), bumpFeeAction(0), */columnResizingFixer(0)
{
    ...
    //bumpFeeAction->setObjectName(QStringLiteral("bumpFeeAction"));
...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    if(WizblcoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(WizblcoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
