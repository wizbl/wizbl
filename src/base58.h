...
/** base58-encoded Wizblcoin addresses.
...
public:
    ...
    CWizblcoinAddress() {}
    CWizblcoinAddress(const CTxDestination &dest) { Set(dest); }
    CWizblcoinAddress(const CTxDestination &dest, const CChainParams &params) { Set(dest, params); }
...
template<typename K, int Size, CChainParams::Base58Type Type> class CWizblcoinExtKeyBase : public CBase58Data
{
public:
...
typedef CWizblcoinExtKeyBase<CExtPubKey, BIP32_EXTKEY_SIZE, CChainParams::EXT_PUBLIC_KEY> CWizblcoinExtPubKey;
