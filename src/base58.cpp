...
bool CBase58Data::SetString(const char* psz, unsigned int nVersionBytes)
{
    ...
    LogPrintfd("vchTemp%s", MemToStr("vchTemp", vchTemp.data(), vchTemp.size()));
...
bool CWizblcoinAddress::Set(const CTxDestination& dest)
{
...
bool CWizblcoinAddress::Set(const CTxDestination& dest, const CChainParams &params)
{
...
CTxDestination CWizblcoinAddress::Get() const
{
    return Get(Params());
}

CTxDestination CWizblcoinAddress::Get(const CChainParams &params) const
{
    if (!IsValid(params))
