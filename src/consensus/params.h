...
struct Params {
    ...
    int BIP66Height;
    /** Block height at which Wizblcoin GPU hard fork becomes active */
    //int WBLHeight;
    ...
    /** Limit WIZBLCOIN_MAX_FUTURE_BLOCK_TIME **/
    int64_t WBLMaxFutureBlockTime;
    /** Premining blocks for Wizblcoin GPU hard fork **/
    //int WBLPremineWindow;
    //bool WBLPremineEnforceWhitelist;
    /**
...
#endif // WIZBLCOIN_CONSENSUS_PARAMS_H
