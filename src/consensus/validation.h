...
static inline int64_t GetBlockWeight(const CBlock& block, const Consensus::Params& params)
{
    ...
    //int ser_flag = (block.nHeight < (uint32_t)params.WBLHeight) ? SERIALIZE_BLOCK_LEGACY : 0;
    //int ser_flag = SERIALIZE_BLOCK_LEGACY;
...
#endif // WIZBLCOIN_CONSENSUS_VALIDATION_H
