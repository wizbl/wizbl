...
//double GetDifficultyWizblcoin(const CBlockIndex* blockindex)
//{
...
//    }
//
//    //if (0/*blockindex->nHeight >= Params().GetConsensus().WBLHeight*/)
//    //{
//    //    return GetDifficultyINTERNAL(blockindex);
//    //}
//    //else
//    //{
//    //    return GetDifficultyWizblcoin(blockindex);
//    //}
//    return GetDifficultyWizblcoin(blockindex);
//}
...
UniValue blockheaderToJSON(const CBlockIndex* blockindex)
{
    ...
    result.push_back(Pair("GenerateID", blockindex->iGenerateID));
    result.push_back(Pair("VerificationLength", blockindex->iVerificationLength));
    result.push_back(Pair("sig", HexStr(blockindex->sig)));
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    //int ser_flags = (blockindex->nHeight < consensusParams.WBLHeight) ? SERIALIZE_BLOCK_LEGACY : 0;
    //int ser_flags = SERIALIZE_BLOCK_LEGACY;
    result.push_back(
        Pair("strippedsize",
    ...
    result.push_back(Pair("GenerateID", block.iGenerateID));
    result.push_back(Pair("VerificationLength", block.iVerificationLength));
    result.push_back(Pair("sig", HexStr(block.sig)));
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of " TEXT_wizbl "coin addresses\n"
