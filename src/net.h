...
#ifndef WIZBLCOIN_NET_H
#define WIZBLCOIN_NET_H
...
public:
    ...
    void ResetFilterInventoryKnown();
    ...
    bool IsLegacyBlockHeader(int version) { return version < WBL_HARD_FORK_VERSION; };
};
