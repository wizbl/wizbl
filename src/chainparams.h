...
#ifndef WIZBLCOIN_CHAINPARAMS_H
#define WIZBLCOIN_CHAINPARAMS_H
 ...
 * Wizblcoin system. There are three: the main network on which people trade goods
...
public:
    ...
    {
        if(height >= consensus.WBLEquihashForkHeight) {
    ...
    bool EquihashUseWBLSalt(int height) const
    {
        return height >= consensus.WBLEquihashForkHeight;
    }
