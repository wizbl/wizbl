Wizblcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/wizblcoin/files/Wizblcoin/wizblcoin-0.5.4/
...
http://gitorious.org/wizblcoin/wizblcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Wizblcoin-Qt notifications under Growl 1.3.
Increase required age of Wizblcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWizblcoin properly when installing Wizblcoin-Qt over it. (Windows)
