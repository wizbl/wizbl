Wizblcoin Core version 0.13.2 is now available from:

  <https://wizblcoin.org/bin/wizblcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update wizblcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow wizblcoin-tx to create v2 transactions (btcdrak)
