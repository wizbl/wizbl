Wizblcoin Core version 0.9.2.1 is now available from:

  https://wizblcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 WBL to 0.01 WBL
...
- Fix "Start wizblcoin on system login"
