Download URL: https://sourceforge.net/projects/wizblcoin/files/Wizblcoin/wizblcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 WBL fee schedule (users still pay 0.01 WBL per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #wizblcoin00 - #wizblcoin99
