Wizblcoin Core version 0.10.4 is now available from:

  <https://wizblcoin.org/bin/wizblcoin-core-0.10.4/>
...
- #6953 `43c2789` Split wizblcoin-tx into its own package
- #6953 `dfe0d4d` Include wizblcoin-tx binary on Debian/Ubuntu
