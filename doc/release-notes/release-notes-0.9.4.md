Wizblcoin Core version 0.9.4 is now available from:

  https://wizblcoin.org/bin/0.9.4/
...
this update is incompatible with the Wizblcoin system and could lead to consensus
forks.

Wizblcoin Core released binaries from https://wizblcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~wizblcoin/+archive/ubuntu/wizblcoin
- A third-party or self-compiled Wizblcoin Core

upgrade to Wizblcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
