Wizblcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/wizblcoin/files/Wizblcoin/wizblcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Wizblcoin
...
New/changed settings (command-line or wizblcoin.conf file)
--------------------------------------------------------
