...
This document provides guidelines for internationalization of the Wizblcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wizblcoin_en.ts` remains unchanged.
