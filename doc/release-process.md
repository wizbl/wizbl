...
- Detached signatures will then be committed to the [wizblcoincore-detached-sigs](https://github.com/wizbl/wizblcoincore-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
