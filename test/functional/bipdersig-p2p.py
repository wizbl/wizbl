...
class BIP66Test(WizblcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # wizblcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and wizblcoind produces more specific reject
            # reasons.
