...
class WalletTest(WizblcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 WBL from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 WBL in block rewards plus fees, but
        ...
        # Send 10 WBL with subtract fee from amount
        ...
        # Sendmany 10 WBL with subtract fee from amount
