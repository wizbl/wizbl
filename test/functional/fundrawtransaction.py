...
from test_framework.test_framework import WizblcoinTestFramework, WIZBLCOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(WizblcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid wizblcoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.wizblcoind_processes[1].wait(timeout=WIZBLCOIND_PROC_WAIT_TIMEOUT)
