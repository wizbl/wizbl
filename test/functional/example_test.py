...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WizblcoinTestFramework
    pass

class ExampleTest(WizblcoinTestFramework):
    # Each functional test is a subclass of the WizblcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        WizblcoinTestFramework class so other tests can use it."""
